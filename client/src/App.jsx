...
function App() {
  ...
  useEffect(() => {
    ...
    const themeClasses = ['light-theme', 'theme-onyx', 'theme-amoxdark', 'theme-ayu', 'theme-nord', 'theme-islands', 'theme-sterlingdark', 'theme-ivory', 'theme-mist', 'theme-amoxlight', 'theme-sterlinglight'];
