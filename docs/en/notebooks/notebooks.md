...
Editor on the left, result on the right, and **280 px tall, always the same**. That is not an oversight: with cells that grow, a twenty-cell notebook stops being something you can scan. For close work there is full screen.
