...
| [temas.html](temas.html) | **Referencia visual generada**: los 10 temas con sus superficies, texto, bordes, sintaxis, tipos y feedback medidos; los 20 acentos en oscuro y claro; las 24 paletas de gráficos con sus gemelos de leyenda | Elijas un color para un gráfico, una diapositiva o un componente nuevo. Se regenera con `node scripts/genThemeReference.cjs` |
