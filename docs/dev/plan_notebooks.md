...
> casi todo—. Quedó en **500**: unas veintitrés líneas de SQL y dieciocho filas. La regla no
> cambia; el número sí, y hacía falta usarlo para verlo — el contrato visual daba el mínimo,
> no el cómodo.
